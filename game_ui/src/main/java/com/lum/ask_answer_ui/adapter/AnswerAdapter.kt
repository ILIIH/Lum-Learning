package com.lum.ask_answer_ui.adapter
...
import com.lum.ask_answer_ui.databinding.AnswerItemBinding

class AnswerAdapter(private val goToNextCard: (answerResult:Boolean) -> Unit) : ListAdapter<Answer, AnswerAdapter.AnswerItemViewHolder>(
    DiffCallBack()
) {

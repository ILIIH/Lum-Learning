package com.lum.ask_answer_ui.fragments.RuleFragment
...
import com.lum.add_new_card.fragments.RuleFragment.RuleFragmentArgs
...
import com.lum.ask_answer_ui.databinding.FragmentGameRuleBinding
...
import com.lum.core.ui.BaseFragment
...
class RuleFragment : BaseFragment() , AndroidScopeComponent {
    ...
    fun showRuleScreen(view: FragmentGameRuleBinding, themeId: Int) {
        ...
        view.teacher.startButton.text = getString(com.lum.core.R.string.next)
    ...
    private fun saveGameResult(themeId: Int) {
        val date = SimpleDateFormat(context?.getString(com.lum.core.R.string.data_format)).format(Date())

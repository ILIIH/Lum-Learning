package com.lum.plain_ui.customView
...
class GrantDiagram @JvmOverloads constructor(
    ...
    // Цвета градиента
    private val gradientStartColor = ContextCompat.getColor(context, com.lum.core.R.color.secondary)
    private val gradientEndColor = ContextCompat.getColor(context, com.lum.core.R.color.primary)

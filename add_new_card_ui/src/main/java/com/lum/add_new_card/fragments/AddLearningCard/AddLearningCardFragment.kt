package com.lum.add_new_card.fragments.AddLearningCard
...
import com.lum.add_new_card.databinding.FragmentAddLearningCardBinding
                ...
                .setPositiveButton(
                    ...
                    if (themeType == 5) {
                        cardViewModel.addNewCard(
                            ...
                            answers = answers,
                            themeType = themeType,
                            currentDate = SimpleDateFormat(getString(com.lum.core.R.string.data_format)).format(
                                Date(),
                            ),

package com.lum.add_new_card.adapters
...
import com.lum.add_new_card.databinding.AnswerAdapterItemBinding
import com.lum.add_new_card_data.model.Answer
    ...
    fun validateAnswers(): Boolean {
        ...
        bindings.forEach {
            if(it.answer.text.isEmpty()){
                ...
                it.answerLayout.setBackgroundResource(com.lum.core.R.drawable.rounded_edit_text_background)
            }
            if(it.hint.isChecked &&  it.answerHint.text.isEmpty()){
                ...
                it.answerHintLayout.setBackgroundResource(com.lum.core.R.drawable.rounded_edit_text_background)
            }
        }
        bindings.clear()
    ...
    inner class AnswerItemViewHolder(
        ...
        fun bind() {
            ...
            binding.answer.addTextChangedListener {
                binding.answerLayout.setBackgroundResource(com.lum.core.R.drawable.rounded_edit_text_background)
            }
            binding.answerHint.addTextChangedListener {
                binding.answerHintLayout.setBackgroundResource(com.lum.core.R.drawable.rounded_edit_text_background)
            }
